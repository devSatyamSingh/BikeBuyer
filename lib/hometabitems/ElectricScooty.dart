...
class ElectricScootyTab extends StatefulWidget {
  const ElectricScootyTab ({super.key});

  @override
  State<ElectricScootyTab > createState() => _ElectricScootyTabState();
}

class _ElectricScootyTabState extends State<ElectricScootyTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: const FilteredVehiclePage(
        category: "scooty",
        subCategoryName: "electronic Scooty",
      ),
    );
