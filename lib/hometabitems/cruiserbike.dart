...
class CruiserBikePage extends StatefulWidget {
  const CruiserBikePage({super.key});

  @override
  State<CruiserBikePage> createState() => _CruiserBikePageState();
}

class _CruiserBikePageState extends State<CruiserBikePage> {
