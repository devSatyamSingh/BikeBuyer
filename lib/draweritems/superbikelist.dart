...
class SuperBikeList extends StatefulWidget {
  const SuperBikeList({super.key});

  @override
  State<SuperBikeList> createState() => _SuperBikeListState();
}

class _SuperBikeListState extends State<SuperBikeList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Super Bike", style: TextStyle(fontWeight: FontWeight.w500, fontFamily: 'Poppins',),),
        toolbarHeight: 60,
